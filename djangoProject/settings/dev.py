...
# 追加导包路劲
sys.path.insert(0, os.path.join(BASE_DIR, 'djangoProject/apps'))

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-6274-c2uy3wb5tg^hfwnw2=e$d+zhqr_dycubdz&#f7v#dp6so'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(Path(__file__).resolve().parent.parent.parent, 'logs/djangoProject.log'),
            # 日志文件的位置
